...
A collection of agent skills (slash commands and behaviors) loaded by Claude Code. Skills are consumed by per-repo configuration emitted by `/setup-repo-skills`.
